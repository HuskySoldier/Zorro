...
@Database(
    entities = [SemestreEntity::class, RamoEntity::class, TareaEntity::class, NotaEntity::class], // Aquí registras tus tablas
    version = 3,
    exportSchema = false
)
abstract class AppDatabase : RoomDatabase() {

    // Aquí expones los DAOs para que el resto de la app los use
